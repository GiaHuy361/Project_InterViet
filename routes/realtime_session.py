...
async def create_session(
    ...
    try:
        ...
        session_res, provider, actual_model, active_api_key = await generate_realtime_session(payload)
        ...
        if provider == "openai" and client_secret_val:

            ACTIVE_PROXY_SESSIONS[client_secret_val] = {
                "provider": "openai",
        ...
        if provider == "openai":
            ...
            connect_url = f"https://api.openai.com/v1/realtime/calls?model={actual_model}"
        else:
