...
public class UsageQuotaPolicyConfiguration : IEntityTypeConfiguration<UsageQuotaPolicy>
{
    public void Configure(EntityTypeBuilder<UsageQuotaPolicy> b)
    {
        ...
        b.HasData(
            // --- Free ---
            new UsageQuotaPolicy { Id = Guid.Parse("A1000000-0000-0000-0000-000000000000"), PlanId = fId, FeatureKey = "cv.storage", PeriodType = "total", MaxValue = 5, IsUnlimited = false, CreatedAt = now },
            ...
            new UsageQuotaPolicy { Id = Guid.Parse("A6000000-0000-0000-0000-000000000000"), PlanId = fId, FeatureKey = "resume.upload", PeriodType = "total", MaxValue = 5, IsUnlimited = false, CreatedAt = now },
            new UsageQuotaPolicy { Id = Guid.Parse("A7000000-0000-0000-0000-000000000000"), PlanId = fId, FeatureKey = "resume.parse", PeriodType = "total", MaxValue = 5, IsUnlimited = false, CreatedAt = now },
            ...
            // --- Monthly ---
            new UsageQuotaPolicy { Id = Guid.Parse("B1000000-0000-0000-0000-000000000000"), PlanId = mId, FeatureKey = "cv.storage", PeriodType = "total", MaxValue = 30, IsUnlimited = false, CreatedAt = now },
            ...
            new UsageQuotaPolicy { Id = Guid.Parse("B6000000-0000-0000-0000-000000000000"), PlanId = mId, FeatureKey = "resume.upload", PeriodType = "subscription", MaxValue = 30, IsUnlimited = false, CreatedAt = now },
            new UsageQuotaPolicy { Id = Guid.Parse("B7000000-0000-0000-0000-000000000000"), PlanId = mId, FeatureKey = "resume.parse", PeriodType = "subscription", MaxValue = 30, IsUnlimited = false, CreatedAt = now },
            ...
            // --- Quarterly ---
            new UsageQuotaPolicy { Id = Guid.Parse("C1000000-0000-0000-0000-000000000000"), PlanId = qId, FeatureKey = "cv.storage", PeriodType = "total", MaxValue = 100, IsUnlimited = false, CreatedAt = now },
            ...
            new UsageQuotaPolicy { Id = Guid.Parse("C6000000-0000-0000-0000-000000000000"), PlanId = qId, FeatureKey = "resume.upload", PeriodType = "subscription", MaxValue = 100, IsUnlimited = false, CreatedAt = now },
            new UsageQuotaPolicy { Id = Guid.Parse("C7000000-0000-0000-0000-000000000000"), PlanId = qId, FeatureKey = "resume.parse", PeriodType = "subscription", MaxValue = 100, IsUnlimited = false, CreatedAt = now },
            ...
            new UsageQuotaPolicy { Id = Guid.Parse("D6000000-0000-0000-0000-000000000000"), PlanId = yId, FeatureKey = "resume.upload", PeriodType = "subscription", MaxValue = 999999, IsUnlimited = true, CreatedAt = now },
            new UsageQuotaPolicy { Id = Guid.Parse("D7000000-0000-0000-0000-000000000000"), PlanId = yId, FeatureKey = "resume.parse", PeriodType = "subscription", MaxValue = 999999, IsUnlimited = true, CreatedAt = now },
            ...
            // --- Combo ---
            new UsageQuotaPolicy { Id = Guid.Parse("E1000000-0000-0000-0000-000000000000"), PlanId = cId, FeatureKey = "cv.storage", PeriodType = "total", MaxValue = 3, IsUnlimited = false, CreatedAt = now },
            ...
            new UsageQuotaPolicy { Id = Guid.Parse("E6000000-0000-0000-0000-000000000000"), PlanId = cId, FeatureKey = "resume.upload", PeriodType = "subscription", MaxValue = 3, IsUnlimited = false, CreatedAt = now },
            new UsageQuotaPolicy { Id = Guid.Parse("E7000000-0000-0000-0000-000000000000"), PlanId = cId, FeatureKey = "resume.parse", PeriodType = "subscription", MaxValue = 3, IsUnlimited = false, CreatedAt = now },
            ...
            // --- Weekly ---
            new UsageQuotaPolicy { Id = Guid.Parse("F1000000-0000-0000-0000-000000000000"), PlanId = wId, FeatureKey = "cv.storage", PeriodType = "total", MaxValue = 15, IsUnlimited = false, CreatedAt = now },
            ...
            new UsageQuotaPolicy { Id = Guid.Parse("F6000000-0000-0000-0000-000000000000"), PlanId = wId, FeatureKey = "resume.upload", PeriodType = "subscription", MaxValue = 15, IsUnlimited = false, CreatedAt = now },
            new UsageQuotaPolicy { Id = Guid.Parse("F7000000-0000-0000-0000-000000000000"), PlanId = wId, FeatureKey = "resume.parse", PeriodType = "subscription", MaxValue = 15, IsUnlimited = false, CreatedAt = now },
