    ...
    private static AiParseResumeResult ParsePythonResponse(string body, Guid resumeId)
    {
        try
        {
            ...
            return AiParseResumeResult.Success(
                ...
                skillsJson:      GetStr("skills"),
                experiencesJson: GetStr("experiences"),
                educationsJson:  GetStr("educations"),
                projectsJson:    GetStr("projects"),
                certificationsJson: GetStr("certifications"),
                languagesJson:   GetStr("languages"),
