    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between bg-white dark:bg-slate-900 p-6 rounded-3xl shadow-sm border border-gray-100 sticky top-4 z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">Hồ sơ Chuyên gia</h1>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-3xl bg-white dark:bg-slate-900 p-8 shadow-sm border border-gray-100">
            <h2 className="text-lg font-bold text-gray-900 dark:text-slate-100 mb-6">Thông tin Cơ bản</h2>
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 p-3 text-sm text-gray-900 dark:text-slate-100 focus:bg-white dark:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 transition-all"
              ...
              <div className="grid grid-cols-2 gap-5">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Link Ảnh đại diện (Avatar URL)</label>
                  <input
                    type="url"
                    value={avatarUrl}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full rounded-xl border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 p-3 text-sm text-gray-900 dark:text-slate-100 focus:bg-white dark:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 transition-all resize-none"
        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 p-6 shadow-xl relative overflow-hidden">
            <div className="absolute right-0 top-0 -mt-8 -mr-8 h-32 w-32 rounded-full bg-white dark:bg-slate-900/5 blur-2xl"></div>
            ...
            {profile?.isVerified ? (
              <div className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-cyan-50 dark:bg-cyan-900/30 text-cyan-300 px-3 py-1 text-xs font-semibold border border-cyan-500/30">
          ...
          <div className="rounded-3xl bg-white dark:bg-slate-900 p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {expertise.map(tag => (
                <span key={tag} className="inline-flex items-center gap-1 bg-gray-100 text-gray-700 dark:text-slate-300 px-3 py-1 rounded-full text-xs font-medium">
                  {tag}
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 px-3 py-1.5 text-sm focus:bg-white dark:bg-slate-900 focus:outline-none focus:border-cyan-400"
                placeholder="Thêm kỹ năng..."
              />
              <button onClick={() => handleAddTag(setExpertise, newExpertise, setNewExpertise)} className="rounded-lg bg-gray-100 px-3 hover:bg-gray-200 transition-colors"><Plus className="h-4 w-4 text-gray-600 dark:text-slate-400" /></button>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-white dark:bg-slate-900 p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {industries.map(tag => (
                <span key={tag} className="inline-flex items-center gap-1 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 border border-purple-100 dark:border-purple-800/50 px-3 py-1 rounded-full text-xs font-medium">
                  {tag}
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 px-3 py-1.5 text-sm focus:bg-white dark:bg-slate-900 focus:outline-none focus:border-purple-400"
                placeholder="Thêm ngành..."
              />
              <button onClick={() => handleAddTag(setIndustries, newIndustry, setNewIndustry)} className="rounded-lg bg-gray-100 px-3 hover:bg-gray-200 transition-colors"><Plus className="h-4 w-4 text-gray-600 dark:text-slate-400" /></button>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-white dark:bg-slate-900 p-6 shadow-sm border border-gray-100">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {languages.map(tag => (
                <span key={tag} className="inline-flex items-center gap-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-100 dark:border-blue-800/50 px-3 py-1 rounded-full text-xs font-medium">
                  {tag}
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-950 px-3 py-1.5 text-sm focus:bg-white dark:bg-slate-900 focus:outline-none focus:border-blue-400"
                placeholder="Thêm ngôn ngữ..."
              />
              <button onClick={() => handleAddTag(setLanguages, newLanguage, setNewLanguage)} className="rounded-lg bg-gray-100 px-3 hover:bg-gray-200 transition-colors"><Plus className="h-4 w-4 text-gray-600 dark:text-slate-400" /></button>
            </div>
          </div>
        </div>
      </div>
