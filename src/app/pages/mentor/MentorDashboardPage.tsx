  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {/* Pending */}
        <div className="group relative overflow-hidden rounded-3xl bg-white p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500">Chờ xác nhận</p>
              <p className="mt-2 text-3xl font-bold text-gray-900">{data?.pendingBookingsCount || 0}</p>
            </div>
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-white p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-gray-900">{data?.confirmedBookingsCount || 0}</p>
            </div>
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-white p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-gray-900">{data?.completedBookingsCount || 0}</p>
            </div>
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-white p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-bold text-gray-900">{data?.cancelledBookingsCount || 0}</p>
            </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-1">
          <div className="rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 p-6 text-white shadow-xl relative overflow-hidden">
            <div className="absolute right-0 top-0 -mt-8 -mr-8 h-32 w-32 rounded-full bg-white/10 blur-2xl"></div>
            ...
            <div className="mt-6 flex items-center gap-3 rounded-2xl bg-white/10 p-4 backdrop-blur-md">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm border border-gray-100">
            ...
            <div className="mt-2 flex items-center gap-3">
              <span className="text-4xl font-bold text-gray-900">{data?.averageRating?.toFixed(1) || '0.0'}</span>
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-gray-500">Dựa trên các lượt đánh giá</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2">
          <div className="rounded-3xl bg-white shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full">
            ...
            <div className="p-6 flex-1">
              {(!data?.recentBookings || data.recentBookings.length === 0) ? (
                <div className="flex h-full flex-col items-center justify-center text-center">
                  ...
                  <p className="text-sm font-medium text-gray-900">Chưa có lịch hẹn nào</p>
                  <p className="mt-1 text-sm text-gray-500">Khi ứng viên đặt lịch, thông tin sẽ xuất hiện tại đây.</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {data.recentBookings.map((booking) => (
                    <div key={booking.id} className="flex items-center gap-4 rounded-2xl border border-gray-100 p-4 transition-colors hover:bg-gray-50">
                      <div className="flex h-12 w-12 shrink-0 flex-col items-center justify-center rounded-xl bg-cyan-50 text-cyan-700">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="truncate text-base font-semibold text-gray-900">{booking.serviceType || 'Dịch vụ Tư vấn'}</p>
